              ...
              <div className="flex items-center justify-between w-full md:w-auto">
                ...
                <div className="-mr-2 flex items-center md:hidden">
                  <button
                   ...
                   <svg className="text-p1" xmlns="http://www.w3.org/2000/svg" width="24" height="13"><g stroke="currentColor" fillRule="evenodd"><path d="M0 0h24v1H0zM0 6h24v1H0zM0 12h24v1H0z"/></g></svg>
                  </button>
                </div>
              </div>
            </div>
