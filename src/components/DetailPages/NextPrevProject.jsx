...
export default function NextPrevProject({ next_project, previous_project }) {
  ...
  return (
    <div className="flex">
      <div className="flex flex-col items-start w-1/2 py-6 border-t border-b border-r border-opacity-25 lg:py-8 justfy-center border-p3">
      ...
      <div className="flex flex-col items-end w-1/2 py-6 border-t border-b border-opacity-25 lg:py-8 justfy-center border-p3">
